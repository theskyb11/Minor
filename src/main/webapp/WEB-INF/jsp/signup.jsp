                ...
                <div class="signin-signup">
                    <form action="loginform" method="post" class="sign-in-form" id="form">
                        ...
                        <div class="social-media">
                            ...
                            <a href="https://www.instagram.com/thesky.b_11/" target="_blank" class="social-icon">
                                <i class="fab fa-instagram"></i>
                            </a>
                            <a href="https://www.linkedin.com/in/samarp-jain-194676229" target="_blank" class="social-icon">
            ...
            <div class="panels-container">
                <div class="panel left-panel">
                    <div class="content">
                        <h3>New here ?</h3>
                        <p>
                            Please enter your personal details to get started with Projekta
                        </p>
                        <button class="btn transparent" id="sign-up-btn">
                            Sign up
                        </button>
                    </div>
                    <img src="https://www.linkpicture.com/q/log-removebg-preview.png" class="image" alt="" />
                </div>
                <div class="panel right-panel">
                    <div class="content">
                        <h3>One of us ?</h3>
                        <p>
                            Please enter your registered credentials with Projekta
                        </p>
                        <button class="btn transparent" id="sign-in-btn">
                            Sign in
                        </button>
                    </div>
                    <img src="https://www.linkpicture.com/q/register-removebg-preview.png" class="image" alt="" />
                </div>
            </div>
        </div>
