            ...
            <div class="row">
                <div align="center" class="col">
                    <%try{
                        ...
                        while(rst.next()){
                            if(rst.getString("progress").equals("Yes")){%>Project Completed<%}else{%>Project Not Completed<%}
                        }
                        }
                    catch(Exception k){
                        k.getMessage();
                        ...
                        <div align="center" class="card" style="width: 60%;">
                            ...
                            <div class="card-body" style="margin-bottom: 0px; margin-top: 0px;">
                                <blockquote class="blockquote mb-0">
                                    ...
                                    <g>End Date: </g><d><%=rs1.getString("end_date")%></d><br><g>Type: </g><d><%=rs1.getString("task_type")%></d>
                                    </p><%;
                            ...
                            <div id="expanded-content" style="display: none;">
                                ...
                                <%if(b == true){%>Submitted<%}else{%>Not Submitted<%}%>
                                <div align="right" style="display: inline-block;">
                                    
                                    <div class="custom-checkbox">
                                        <input type="checkbox" <% if (b == false || b == true) { %> disabled<% } if (b == true) { %> checked<% }%>>
                                        <label for="checkbox">
                                            <i class="fas fa-check"></i>
                                        </label>
                                    </div>
